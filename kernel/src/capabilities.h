...
// looks up a capability from its address within the given capability node
// on success, true is returned. on failure, false is returned
bool look_up_capability(struct capability *root, size_t address, size_t depth, struct look_up_result *result);

// looks up a capability relative to either the kernel root capability or the current thread's root capability
// on success, true is returned. on failure, false is returned
bool look_up_capability_relative(size_t address, size_t depth, bool from_userland, struct look_up_result *result);

// looks up a capability relative to a given thread's root capability node
// on success, true is returned. on failure, false is returned
